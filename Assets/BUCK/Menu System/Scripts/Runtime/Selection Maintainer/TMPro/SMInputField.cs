...
namespace BUCK.MenuSystem.SelectionMaintainer.TMPro
{
    /// <summary>
    /// InputField class to use in order to keep UI selection at all times.
    /// </summary>
    [AddComponentMenu("UI/Input Field (Selection Maintainer, Text Mesh Pro)")]
    public class SMInputField : TMP_InputField
    {
        /// <summary>
