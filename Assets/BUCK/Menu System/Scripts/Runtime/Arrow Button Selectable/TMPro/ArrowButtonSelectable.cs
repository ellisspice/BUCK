...
namespace BUCK.MenuSystem.ArrowButtons.TMPro
{
    /// <inheritdoc />
    [AddComponentMenu("UI/Arrow Button Selectable (Text Mesh Pro)")]
    public class ArrowButtonSelectable : BaseArrowButtonSelectable<TextMeshProUGUI>
    {
#if LOCALIZATION_SYSTEM_INCLUDED
        /// <summary>
